...
public class QuestManager : MonoBehaviour
{
    ...
    {
        QuestCornerPopUp = GameObject.Find("CornerPopUp");
        QuestCornerDescription = GameObject.Find("CornerPopUpText").GetComponent<TMPro.TextMeshProUGUI>();
        QuestCornerTitle = GameObject.Find("CornerPopUpTitle").GetComponent<TMPro.TextMeshProUGUI>();
