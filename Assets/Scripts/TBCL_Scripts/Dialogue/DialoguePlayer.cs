...
public class DialoguePlayer : MonoBehaviour
{
    ...
    void Start()
    {
        // gameManager = GameObject.Find("TBCL-GameManager");
        // dialoguePopUp = GameObject.Find("DialoguePopUp");
        // dialogueText = GameObject.Find("DialogueText").GetComponent<TextMeshProUGUI>();
        // speakerLeft = GameObject.Find("DialogueSpeakerTextLeft").GetComponent<TextMeshProUGUI>();
        // speakerRight = GameObject.Find("DialogueSpeakerTextRight").GetComponent<TextMeshProUGUI>();
        // popUpLeft = GameObject.Find("Speaker_Left");
        // popUpRight = GameObject.Find("Speaker_Right");
    }
